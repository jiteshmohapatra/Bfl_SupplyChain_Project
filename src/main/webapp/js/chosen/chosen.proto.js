...
(function () {
  let AbstractChosen; let SelectParser;
  ...
  SelectParser = (function () {
    ...
    SelectParser.prototype.add_group = function (group) {
      let group_position; let i; let len; let option; let ref; let
        results1;
  ...
  SelectParser.select_to_array = function (select) {
    let child; let i; let len; let parser; let
      ref;
  ...
  AbstractChosen = (function () {
    ...
    AbstractChosen.prototype.results_option_build = function (options) {
      let content; let data; let data_content; let i; let len; let ref; let
        shown_results;
      content = '';
      shown_results = 0;
    ...
    AbstractChosen.prototype.reset_single_select_options = function () {
      let i; let len; let ref; let result; let
        results1;
      ref = this.results_data;
      results1 = [];
      for (i = 0, len = ref.length; i < len; i++) {
    ...
    AbstractChosen.prototype.winnow_results = function (options) {
      let escapedQuery; let fix; let i; let len; let option; let prefix; let query; let ref; let regex; let results; let results_group; let search_match; let startpos; let suffix; let
        text;
  ...
  this.Chosen = (function (superClass) {
    ...
    Chosen.prototype.result_do_highlight = function (el) {
      let high_bottom; let high_top; let maxHeight; let visible_bottom; let
        visible_top;
      this.result_clear_highlight();
    ...
    Chosen.prototype.search_field_scale = function () {
      let container_width; let div; let i; let len; let style; let style_block; let styles; let
        width;
      if (!this.is_multiple) {
        return;
      }
