...
const AsyncStockMovementCombinedShipments = Loadable({
  loader: () =>
    import("components/stock-movement-wizard/StockMovementCombinedShipments"),
  loading: Loading,
});
...
const AsyncStockMovementVerifyRequest = Loadable({
  loader: () =>
    import("components/stock-movement-wizard/StockMovementVerifyRequest"),
  loading: Loading,
});
...
const AsyncProductsConfiguration = Loadable({
  loader: () =>
    import("components/products-configuration/ProductsConfigurationWizard"),
  loading: Loading,
});

const AsyncLocationsConfiguration = Loadable({
  loader: () =>
    import("components/locations-configuration/LocationsConfigurationWizard"),
  loading: Loading,
});
...
const AsyncStockMovementInboundList = Loadable({
  loader: () =>
    import("components/stock-movement/inbound/StockMovementInboundList"),
  loading: Loading,
});

const AsyncStockMovementOutboundList = Loadable({
  loader: () =>
    import("components/stock-movement/outbound/StockMovementOutboundList"),
  loading: Loading,
});
...
const AsyncOutboundImport = Loadable({
  loader: () =>
    import("components/stock-movement-wizard/outboundImport/OutboundImport"),
  loading: Loading,
});
...
const Router = (props) => {
  ...
  const Dashboard =
    !props.supportedActivities.includes("MANAGE_INVENTORY") &&
    props.supportedActivities.includes("SUBMIT_REQUEST")
    ...
    <div>
      <BrowserRouter>
        <FlashScopeListenerWrapper>
          <Switch>
            <MainLayoutRoute
              path="**/putAway/create/:putAwayId?"
              component={AsyncPutAwayMainPage}
            />
            <MainLayoutRoute
            ...
            />
            <MainLayoutRoute
              path="**/stockMovement/createOutbound/:stockMovementId?"
              component={AsyncStockMovement}
            />
            <MainLayoutRoute
              path="**/stockMovement/importOutboundStockMovement"
              component={AsyncOutboundImport}
            />
            <MainLayoutRoute
              path="**/inventory/cycleCount/count"
              component={AsyncCycleCountCountStep}
            />
            <MainLayoutRoute
              path="**/inventory/cycleCount/resolve"
              component={AsyncCycleCountResolveStep}
            />
            <MainLayoutRoute
              path="**/inventory/cycleCount"
              component={AsyncCycleCount}
            />
            <MainLayoutRoute
              path="**/stockMovement/createInbound/:stockMovementId?"
              component={AsyncStockMovementInbound}
            />
            <MainLayoutRoute
              path="**/stockMovement/createCombinedShipments/:stockMovementId?"
              component={AsyncStockMovementCombinedShipments}
            />
            <MainLayoutRoute
              path="**/stockMovement/createRequest/:stockMovementId?"
              component={AsyncStockMovementRequest}
            />
            <MainLayoutRoute
              path="**/stockMovement/verifyRequest/:stockMovementId?"
              component={AsyncStockMovementVerifyRequest}
            />
            <MainLayoutRoute
              path="**/stockMovement/create/:stockMovementId?"
              component={AsyncStockMovement}
            />
            <MainLayoutRoute
              path="**/partialReceiving/create/:shipmentId"
              component={AsyncReceivingPage}
            />
            <MainLayoutRoute
              path="**/stocklistManagement/index/:productId?"
              component={AsyncManagement}
            />
            <MainLayoutRoute
              path="**/invoice/create/:invoiceId?"
              component={AsyncInvoice}
            />
            <MainLayoutRoute
              path="**/invoice/list"
              component={AsyncInvoiceList}
            />
            <MainLayoutRoute
              path="**/stockTransfer/create/:stockTransferId?"
              component={AsyncStockTransfer}
            />
            <MainLayoutRoute
              path="**/stockTransfer/createOutboundReturn/:outboundReturnId?"
              component={AsyncOutboundReturns}
            />
            <MainLayoutRoute
              path="**/stockTransfer/createInboundReturn/:inboundReturnId?"
              component={AsyncInboundReturns}
            />
            <MainLayoutRoute
              path="**/replenishment/create/:replenishmentId?"
              component={AsyncReplenishment}
            />
            <MainLayoutRoute
              path="**/productsConfiguration/index"
              component={AsyncProductsConfiguration}
            />
            <MainLayoutRoute
              path="**/locationsConfiguration/create/:locationId?"
              component={AsyncLocationsConfiguration}
            />
            <MainLayoutRoute
              path="**/locationsConfiguration/upload"
              component={AsyncImportLocations}
            />
            <Route path="**/locationsConfiguration/index">
              <AsyncWelcomePage />
            </Route>
            <Route path="**/loadData/index">
              <AsyncLoadDataPage />
            </Route>
            ...
            <MainLayoutRoute
              ...
              component={AsyncPurchaseOrderList}
            />
            <MainLayoutRoute
              path="**/requisitionTemplate/list"
              component={AsyncStockList}
            />
            <MainLayoutRoute
              path="**/product/list"
            ...
            />
            <MainLayoutRoute
              path="**/stockTransfer/list"
              component={AsyncStockTransferList}
            />
            <MainLayoutRoute
              path="**/productSupplier/list"
              component={AsyncProductSupplierList}
            />
            <MainLayoutRoute
              path="**/productSupplier/create/:productSupplierId?"
              component={AsyncProductSupplierCreatePage}
            />
            <MainLayoutRoute
