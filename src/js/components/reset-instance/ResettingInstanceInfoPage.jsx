...
const ResettingInstanceInfoPage = ({ history }) => {
  ...
  return (
    <div className="modal-page">
      <div
        className="modal-page__content position-relative d-flex"
        style={{ minHeight: "200px" }}
      >
        <h3 className="font-weight-bold my-3">
          <Translate
            id="react.resetInstance.header.label"
            defaultMessage="Reset your instance"
          />
        </h3>
        <p>
          <Translate
            id="react.resetInstance.content.label"
            defaultMessage="To reset your instance request your system admin to run this script in terminal:"
          />
        </p>
        ...
        >
          <Translate
            id="react.resetInstance.backToDashboard.button.label"
