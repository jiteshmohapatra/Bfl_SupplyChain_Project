...
const DropdownMenu = ({ section, active }) => {
  const { elementReference, setIsVisible, shouldAlignLeft } =
    useCheckRightSpace();
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`dropdown-menu dropdown-menu-wrapper ${shouldAlignLeft() ? "dropdown-menu-left" : "dropdown-menu-right"}`}
