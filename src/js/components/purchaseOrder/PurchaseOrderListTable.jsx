...
const PurchaseOrderListTable = ({
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        Header: (
          <Translate
            id="react.purchaseOrder.column.status.label"
        ...
        Cell: (row) => (
          <TableCell
            {...row}
            tooltip
            tooltipLabel={getStatusTooltip(row.original.status)}
          >
      ...
      },
      {
        ...
        width: 150,
        Cell: (row) => (
          <TableCell {...row} link={ORDER_URL.show(row.original.id)} />
        ),
      },
      {
        Header: (
          <Translate
            id="react.purchaseOrder.column.name.label"
            defaultMessage="Name"
          />
        ),
        accessor: "name",
        ...
        minWidth: 250,
        Cell: (row) => (
          <TableCell {...row} tooltip link={ORDER_URL.show(row.original.id)} />
        ),
      },
      {
        Header: (
          <Translate
            id="react.purchaseOrder.column.supplier.label"
      ...
      },
      {
        Header: (
          <Translate
            id="react.purchaseOrder.column.ordered.label"
      ...
      },
      {
        Header: (
          <Translate
            id="react.purchaseOrder.column.shipped.label"
      ...
      },
      {
        Header: (
          <Translate
            id="react.purchaseOrder.column.received.label"
      ...
      },
      {
        Header: (
          <Translate
            id="react.purchaseOrder.column.invoiced.label"
  ...
  const totalAmount = () =>
    `${translate("react.purchaseOrder.totalAmount.label", "Total amount")}: ${tableData.totalPrice.toLocaleString([locale, "en"])} ${currencyCode}`;
  ...
  return (
    <div className="list-page-list-section">
      <div className="title-text p-3 d-flex justify-content-between align-items-center">
        <span>
          <Translate
            id="react.purchaseOrder.listOrders.label"
