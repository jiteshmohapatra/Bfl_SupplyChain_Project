  ...
  switch (action.type) {
    case FETCH_SESSION_INFO:
      return {
        ...
        currentLocationRoles: _.get(
          action,
          "payload.data.data.currentLocationRoles",
        ),
        isSuperuser: _.get(action, "payload.data.data.isSuperuser"),
        isUserAdmin: _.get(action, "payload.data.data.isUserAdmin"),
        isUserApprover: _.get(
          action,
          "payload.data.data.isUserApprover",
          false,
        ),
        isUserRequestApprover: _.get(
          action,
          "payload.data.data.isUserRequestApprover",
          false,
        ),
        isUserManager: _.get(action, "payload.data.data.isUserManager", false),
        supportedActivities: _.get(
          action,
          "payload.data.data.supportedActivities",
        ),
        ...
        minimumExpirationDate: _.get(
          action,
          "payload.data.data.minimumExpirationDate",
        ),
        ...
        localizedHelpScoutKey: _.get(
          action,
          "payload.data.data.localizedHelpScoutKey",
        ),
        isHelpScoutEnabled: _.get(
          action,
          "payload.data.data.isHelpScoutEnabled",
        ),
        loading: false,
        localizationModeEnabled: _.get(
          action,
          "payload.data.data.localizationModeEnabled",
          false,
        ),
        localizationModeLocale: _.get(
          action,
          "payload.data.data.localizationModeLocale",
          "ach",
        ),
        displayDateFormat: _.get(
          action,
          "payload.data.data.displayDateFormat",
          "MMM DD, yyyy",
        ),
        displayDateDefaultValue: _.get(
          action,
          "payload.data.data.displayDateDefaultValue",
          "-",
        ),
        notificationAutohideDelay: _.get(
          action,
          "payload.data.data.notificationAutohideDelay",
          8000,
        ),
        browserConnectionTimeout: _.get(
          action,
          "payload.data.data.browserConnectionTimeout",
          0,
        ),
        isAutosaveEnabled: _.get(
          action,
          "payload.data.data.isAutosaveEnabled",
          false,
        ),
        cycleCountMaxSelectedProducts: _.get(
          action,
          "payload.data.data.cycleCountMaxSelectedProducts",
          50,
        ),
      };
    case FETCH_MENU_CONFIG:
      return {
        ...
        menuSectionsUrlParts: _.get(
          action,
          "payload.data.data.menuSectionsUrlParts",
        ),
      };
